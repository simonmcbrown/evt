...
# source("obs-sim-contour-RUN_gem2-multi_mk2.R")

# 2014.10.27 gem2 version to take hadGEM2 data
# mk2 changed to using gpd.fit for margins
...
for(b in 1:nfiles) {
  ...
  sim.events <- DurSevFromSim_mk2(data=dat[,1],marg.obj=dummy.marg.gpd.fit,dep.obj=ht.dep.fit,

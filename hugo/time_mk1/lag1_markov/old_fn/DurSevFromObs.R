...
DurSevFromObs <- function(dat,thresh,max.lb,max.ub,pts.ba,seas.length=92){
  ...
  #declustered.data <- decluster.runs(z=logical.data.to.decluster,r=1,blocks=rep(1:67,each=seas.length))

...
# source("obs-sim-contour-RUN_gem1-multi.R")

# 2014.10.27 gem1 version to take hadGEM1 data
...
### orleans
#infile    <- "~/extremes/tawn/hugo/heatwave/gem1/orleans/all_1234_allyr_daily_tmax_1950_2005.csv"
#savefile0 <- '/project/extremes1/hadsx/RSave.data/orleans_gem1_all_temp_dat_sim_1e5_xxx.RSave'
#psout      <- '~/extremes/tawn/hugo/time_mk1/severity_duration_orleans_gem1_all.ps'
#infile    <- "~/extremes/tawn/hugo/heatwave/gem1/orleans/ant_1234_allyr_daily_tmax_1950_2005.csv"
#savefile0 <- '/project/extremes1/hadsx/RSave.data/orleans_gem1_ant_temp_dat_sim_1e5_xxx.RSave'
#psout      <- '~/extremes/tawn/hugo/time_mk1/severity_duration_orleans_gem1_ant.ps'

### toulouse
infile    <- "~/extremes/tawn/hugo/heatwave/gem1/toulouse/all_1234_allyr_daily_tmax_1950_2005.csv"
savefile0 <- '/project/extremes1/hadsx/RSave.data/toulouse_gem1_all_temp_dat_sim_1e5_xxx.RSave'
psout     <- '~/extremes/tawn/hugo/time_mk1/severity_duration_toulouse_gem1_all.ps'
#infile    <- "~/extremes/tawn/hugo/heatwave/gem1/toulouse/ant_1234_allyr_daily_tmax_1950_2005.csv"
#savefile0 <- '/project/extremes1/hadsx/RSave.data/toulouse_gem1_ant_temp_dat_sim_1e5_xxx.RSave'
#psout     <- '~/extremes/tawn/hugo/time_mk1/severity_duration_toulouse_gem1_ant.ps'

...
# source("obs-sim-contour-RUN_cm3-multi.R")

# 2014.10.27 cm3 version to take hadcm3 data
...
DOPLOT <- FALSE
nsim   <- 1e5
#infile    <- "~/extremes/tawn/hugo/heatwave/cm3/orleans/nat_1234_allyr_daily_tmax_1950_1997.csv"
#savefile0 <- '/project/extremes1/hadsx/RSave.data/orleans_cm3_nat_temp_dat_sim_1e5_xxx.RSave'
#psout      <- '~/extremes/tawn/hugo/time_mk1/severity_duration_orleans_cm3_nat.ps'

infile    <- "~/extremes/tawn/hugo/heatwave/cm3/orleans/ant_1234_allyr_daily_tmax_1950_1999.csv"
savefile0 <- '/project/extremes1/hadsx/RSave.data/orleans_cm3_ant_temp_dat_sim_1e5_xxx.RSave'
psout      <- '~/extremes/tawn/hugo/time_mk1/severity_duration_orleans_cm3_ant.ps'
